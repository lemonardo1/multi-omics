...
adata = sc.read_10x_mtx(
    'data/filtered_feature_bc_matrix/',  # .mtx 파일이 있는 디렉토리
...
plt.tight_layout()
plt.savefig('figures/qc_plots.pdf')
plt.close()
...
adata.write('code/results.h5ad')

print("분석이 완료되었습니다! 결과가 'code/results.h5ad'에 저장되었습니다.") 